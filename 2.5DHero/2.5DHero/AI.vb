'''<summary>
'''This Is An In Dev AI System Meant To Increase And Restructure The AI System For Wild Pokemon While Being Able To Enable And Disable New Features Inside The Options Menu
'''</summary>
...
#Region "Enums"
    ...
    '''</summary>	
 	  ...
 	  '''<summary>
    '''Represents A Wild Pokemon Capable Of Increasing 2 Or More Random IV Stats to 31 Value
    '''</summary>	
		WildAIIVLuck       
